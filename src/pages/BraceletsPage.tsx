...
const CTA_HREF = '/#order';

function CTAButton({ label = 'أُطلب قطعتك الآن', className = '' }: { label?: string; className?: string }) {
  return (
    <a
      href={CTA_HREF}
      className={`inline-block px-12 py-4 bg-[#243247] text-[#e7ddcc] font-semibold transition-all duration-300 hover:bg-[#1a2b3c] hover:shadow-xl hover:-translate-y-0.5 ${className}`}
...
function BraceletSection({ product, index }: { product: (typeof products)[0]; index: number }) {
  ...
  return (
    <>
      <div
        ...
        style={isReversed ? { direction: 'ltr' } : {}}
      >
        ...
        <div className="flex flex-col gap-6" dir="rtl">
          ...
          <div className="space-y-3 py-6 border-t border-b border-[#243247] border-opacity-10">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="text-[#243247] opacity-80 font-semibold" style={{ fontFamily: "'Cinzel', serif" }}>{product.price} جنيه</span>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          ...
          <div className="space-y-24 md:space-y-32">
            {bracelets.map((product, index) => (
              <BraceletSection key={product.id} product={product} index={index} />
            ))}
          </div>
        </div>
      </section>
      ...
      <footer className="bg-[#243247] text-white py-12 md:py-16 border-t border-[#e7ddcc] border-opacity-10">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center mb-10">
            <a
              href={CTA_HREF}
              className="inline-block px-12 py-4 bg-[#e7ddcc] text-[#243247] font-semibold transition-all duration-300 hover:bg-white hover:-translate-y-0.5 hover:shadow-lg"
              style={{ fontFamily: "'Cinzel', serif", letterSpacing: '0.12em', fontSize: '0.875rem' }}
            >
              أُطلب قطعتك
            </a>
          ...
          <div className="border-t border-gray-700 pt-8 text-center text-sm text-gray-400">
            <p style={{ fontFamily: "'Cinzel', serif" }}>© {currentYear} Orzi-1998.</p>
